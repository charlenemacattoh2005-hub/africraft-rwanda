...
const products = [
  ...
  { name: 'Wooden Elephant Carving', description: 'Beautifully hand-carved wooden elephant, a symbol of strength and wisdom.', price: 72000, imageUrl: 'http://gogalgaistore.com/cdn/shop/files/ElephantCarvingbrown1.jpg?v=1705555886', category: 'Wood Carvings', stock: 20, isActive: true, badge: 'Handmade', featured: false },
  ...
  { name: 'Artisan Gift Hamper', description: 'A beautifully curated hamper of Rwandan artisan products.', price: 95000, imageUrl: 'http://curatedwithconscience.com.au/cdn/shop/files/Love-Your-Work-Appreciation-Hamper_267afd3d-e72c-4abc-af95-91302670e20f.jpg?v=1759062654', category: 'Gifts', stock: 15, isActive: true, badge: 'New Arrival', featured: false },
  ...
  { name: 'Handwoven Storage Basket', description: 'Large handwoven storage basket perfect for organizing your home.', price: 40000, imageUrl: 'http://mawuafrica.com/cdn/shop/files/1_71671e07-0786-4b2f-8c9f-5d360a4c0a0e.png?v=1747750568', category: 'Storage', stock: 55, isActive: true, badge: 'Handmade', featured: false },
